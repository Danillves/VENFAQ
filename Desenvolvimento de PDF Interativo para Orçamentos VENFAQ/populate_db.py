#!/usr/bin/env python3
"""
Script para popular o banco de dados com dados iniciais do VENFAQ
    ...
    with app.app_context():
        ...
        itens_data = [
            ...
            },
            {
                'codigo': '48883',
                'titulo': 'VSLOT SYSTEM',
                'descritivo_tecnico': 'Impermeabilização em telhas de fibrocimento com membrana líquida elastômera da marca VENFAQ Vlaje fabricado por ISOLASTECH. Se aplicará uma demão de PRIMER reforçada com tela no perímetro da telha e logo receberá uma segunda demão do FINALIZADOR com proteção a raios UV.',
                'unidade_medida': 'm²',
...
EXECUÇÃO DA OBRA - Será realizada com empresas instaladoras devidamente homologadas pela VENFAQ no prazo especificado de forma continua.
...
PROJECT EXECUTION - Will be carried out by certified installation companies approved by VENFAQ within the specified timeframe.
